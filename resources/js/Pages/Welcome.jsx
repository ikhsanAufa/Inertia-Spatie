...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    // Ini adalah cara untuk menulis dan mengekspor sebuah komponen React secara langsung.
    // export default berarti komponen ini bisa diimpor di file lain tanpa menggunakan {}.
    // ({ auth, laravelVersion, phpVersion })
    // Ini adalah destructuring props, artinya komponen Welcome menerima props:
    // auth → Biasanya berisi informasi tentang pengguna yang login.
    // laravelVersion → Versi Laravel yang sedang digunakan.
    // phpVersion → Versi PHP yang digunakan di server.
